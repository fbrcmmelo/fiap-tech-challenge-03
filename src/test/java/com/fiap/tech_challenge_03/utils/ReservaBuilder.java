...
public class ReservaBuilder {
    ...
    public static Reserva entity() {
        return new Reserva("1", UsuarioBuilder.entity().getId(), RestauranteBuilder.entity().getId(), LocalDateTime.now(), 2, null);
    }
    ...
    public static ReservaOutput output() {
        return new ReservaOutput("1", UsuarioBuilder.entity().getId(), RestauranteBuilder.entity().getId(), LocalDateTime.now(), 2, null);
    }
}
